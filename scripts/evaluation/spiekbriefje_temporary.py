# # we're gonna try something, adapting from Invisible Relevance Bias paper's code
#
# import os
...
#
# def evaluate_retrieval(text_feature, image_feature, gt, text_image_similarities):
...
#     """
#     Calculates nDCG@1, nDCG@3, nDCG@5 for the given text and image features
#     :param text_feature:
#     :param image_feature:
...
#
#
# def get_DCG(text_feature, image_feature, image_feature_generated, gt, gt_generated, text_image_similarities):
#     """
#     Calculates a whole lot, distinguishing on real and generated features
#     :param text_feature:
#     :param image_feature:
#     :param image_feature_generated:
#     :param gt:
#     :param gt_generated:
#     :return:
#     """
#     image_feature_ = torch.concat([image_feature, image_feature_generated])
#     similarities = text_feature @ image_feature_.t()  # cosine similarity between text and image feature
#
#     topk = similarities.topk(10)[1]
...
#
#         with torch.no_grad():
#             for idx, line in tqdm(enumerate(data_list), desc="Computing Image Embeddings", ncols=100,
#                                   total=len(data_list)):
...
#                 image_batch.append(
#                     preprocesor.image_processor(Image.open(os.path.join(image_path, image_file)).convert("RGB"),
#                                                 return_tensors='pt').data['pixel_values'][0])
#
#                 image_batch_generated.append(preprocesor.image_processor(
#                     Image.open(os.path.join(image_path_generated, image_file)).convert("RGB"),
#                     return_tensors='pt').data['pixel_values'][0])
#
...
#                     image_batch_generated = image_batch_generated / image_batch_generated.norm(p=2, dim=-1,
#                                                                                                keepdim=True)
#
#                     image_feature.append(image_batch)
#                     image_feature_generated.append(image_batch_generated)
#
#                     text_batch = preprocesor.tokenizer(text_batch, padding=True, max_length=77, truncation=True,
...
#
#                     for id, similarity, image_image_similarity in zip(id_batch, similarities,
#                                                                       image_image_similarities):
...
#
#         r1, r3, r5 = evaluate_retrieval(text_feature, image_feature, gt, text_image_similarities)
#         r1_g, r3_g, r5_g = evaluate_retrieval(text_feature, image_feature_generated, gt, text_image_similarities)
#         r1_sum += r1
#         r3_sum += r3
#         r5_sum += r5
#
...
#         n3_g_sum += n3_g
#         n5_g_sum += n5_g
#         print(" ndcg@1: {},\n ndcg@3: {},\n ndcg@5: {}".format(round(n1.item(), 2), round(n3.item(), 2),
#                                                                round(n5.item(), 2)))
...
#                       gt_generated, text_image_similarities)
#
...
#
#     """
#     On the different data things:
#
#     - gt - ground truth -  each text feature is expected to correspond to a specific image feature
#     - gt_generated - ground truth for the generated image features, with an offset of text_image_similarities.shape[0]
#       to account for the additional images
#     """
#
#
